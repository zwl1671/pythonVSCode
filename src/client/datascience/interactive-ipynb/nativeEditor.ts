...
export class NativeEditor extends InteractiveBase implements INotebookEditor {
    ...
    protected async sendIPythonShellMsg(payload: { data: any; metadata: any; commId: string; requestId: string; buffers?: any; msgType: string; targetName?: string }) {
        ...
        future.onIOPub = (msg: KernelMessage.IIOPubMessage) => {
            ...
            this.postMessage(IPyWidgetMessages.IPyWidgets_ShellSend_onIOPub, { requestId, msg }).catch(ex => console.error('Failed to post oniopub message for handler', ex));
        ...
        future.onReply = (reply: KernelMessage.IShellMessage) => {
            this.postMessage(IPyWidgetMessages.IPyWidgets_ShellSend_reply, { requestId, msg: reply }).catch(ex => console.error('Failed to post oniopub message for handler', ex));
        };
    }
